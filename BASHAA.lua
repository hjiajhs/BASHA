...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BASHAA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BT", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S BASHAA -X kill
screen -S BASHAA ./BASHAA
done
]])  
file:close() 
...
sudo_users = {SUDO,883938507,883938507,883938507}   
...
if hash or SudoBot(msg) or DevBASHAAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBASHAAW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBASHAAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBASHAAW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBASHAAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBASHAAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBASHAAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(883938507) then  
var = true  
elseif tonumber(user_id) == tonumber(883938507) then
var = true 
elseif tonumber(user_id) == tonumber(883938507) then
var = true  
...
var = true
elseif database:sismember(bot_id..'S666F:MN:TF'..chat_id, user_id) then
var = true  
...
local UserName = (data.username_ or "D666N")
...
local BASHAA_Msg = ''  
if msgs < 100 then 
BASHAA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BASHAA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BASHAA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BASHAA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BASHAA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BASHAA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BASHAA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BASHAA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BASHAA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BASHAA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BASHAA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BASHAA_Msg = 'امبراطور التفاعل' 
elseif msgs < 10000000000 then 
BASHAA_Msg = 'رب التفاعل'  
end 
return BASHAA_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@S666F")  
...
--------------------------------------------------------------------------------------------------------------
function SourceBASHAA(msg,data) -- بداية العمل
if msg then
...
local num = database:smembers(bot_id.."S666F:MN:TF"..msg.chat_id_)
...
SourceBASHAAr = '✟ اهلا عزيزي\n ✟ انا بوت اسمي '..Namebot..'\n ✟ اختصاصي حمايه الكروبات\n ✟ من تكرار والسبام والتوجيه والخ…\n ✟ لتفعيلي اتبع الاخطوات…↓\n ✟ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ✟ [قناة سورس البوت](http://t.me/D666N)'
end 
send(msg.chat_id_, msg.id_, SourceBASHAAr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevBASHAAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevBASHAAW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,BASHAA_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✟' and DevBASHAAW(msg) then  
...
if text == 'تعطيل التواصل ✟' and DevBASHAAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✟' and DevBASHAAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✟' and DevBASHAAW(msg) then  
...
if text == 'ضع كليشه ستارت ✟' and DevBASHAAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ✟ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ✟' and DevBASHAAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ✟ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ✟' and DevBASHAAW(msg) then 
...
if text == 'تحديث السورس ✟' and DevBASHAAW(msg) then 
os.execute('rm -rf BASHAA.lua')
os.execute('wget https://raw.githubusercontent.com/BASHA-TEAM/BASHAA/main/BASHAA.lua')
send(msg.chat_id_, msg.id_,' ✟ تم تحديث السورس \n ✟ لديك اخر اصدار لسورس باشا\n ✟ الاصدار » { 2.0v}')
dofile('BASHAA.lua')  
end
if text == 'الاصدار ✟' and DevBASHAAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✟ اصدار سورس باشا \n ✟ الاصدار »{ 2.0v}')
end
if text == 'قناه تحديثات البوت ✟' and DevBASHAAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✟ [تحديثات البوت](t.me/D666N) \n ✟ [قناه السورس](t.me/D666N)')
end
if text == "ضع اسم للبوت ✟" and DevBASHAAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ✟ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ✟' and DevBASHAAW(msg) then 
...
if text == 'المشتركين ✟' and DevBASHAAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✟ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✟' and DevBASHAAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✟ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✟") and DevBASHAAW(msg) then
...
if text == ("قائمه العام ✟") and DevBASHAAW(msg) then
...
if text == ("قائمه الكتم العام ✟") and DevBASHAAW(msg) then
...
if text=="اذاعه خاص ✟" and msg.reply_to_message_id_ == 0 and DevBASHAAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل الان اذاعتك؟ \n ✟ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ✟" and msg.reply_to_message_id_ == 0 and DevBASHAAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل الان اذاعتك؟ \n ✟ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ✟" and msg.reply_to_message_id_ == 0 and DevBASHAAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل الان اذاعتك؟ \n ✟ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ✟" and msg.reply_to_message_id_ == 0  and DevBASHAAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ✟" and msg.reply_to_message_id_ == 0  and DevBASHAAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✟' and DevBASHAAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✟" and DevBASHAAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✟" and DevBASHAAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'✟  عدد الكروبات الان » { '..#group..' }'..BASHAAk..''..BASHAA..'\n✟  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevBASHAAW(msg) then
...
usertext = '\n ✟ العضو » ['..result.title_..'](t.me/'..(username or 'D666N')..')'
status  = '\n ✟ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevBASHAAW(msg) then
...
usertext = '\n ✟ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'D666N')..')'
status  = '\n ✟ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBASHAAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBASHAAW(msg) then
...
local BASHAA1_Msg = database:get(bot_id.."BASHAA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BASHAA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✟ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'D666N')..') \n ✟ '..BASHAA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if BASHAA_Msg and not Special(msg) then  
local BASHAA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BASHAA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✟ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✟ ["..BASHAA_Msg.."] \n")
else
send(msg.chat_id_,0," ✟ العضو : {["..data.first_name_.."](T.ME/D666N)}\n ✟ ["..BASHAA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✟ عذرا » {["..data.first_name_.."](T.ME/D666N)}\n ✟ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBASHAAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBASHAAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevBASHAAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✟ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBASHAAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✟ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✟" and DevBASHAAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ✟ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✟$") and DevBASHAAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✟ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✟" and DevBASHAAW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✟" and DevBASHAAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ✟ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ✟" and DevBASHAAW(msg) then  
...
database:sadd(bot_id.."BASHAA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."BASHAA:blocname"..msg.chat_id_)
...
function S666F_name(t1,t2)
if t2.id_ then 
name_BASHAA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_BASHAA then 
names_BASHAA = database:smembers(bot_id.."BASHAA:blocname"..msg.chat_id_) or ""
if names_BASHAA and names_BASHAA[1] then 
for i=1,#names_BASHAA do 
if name_BASHAA:match("(.*)("..names_BASHAA[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, S666F_name)
end
...
database:set(bot_id.."BASHAA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."BASHAA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."BASHAA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."BASHAA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."BASHAA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_BASHAAa_new(BASHAA1,BASHAA2)
if BASHAA2 and BASHAA2.first_name_ then 
if BASHAA2.first_name_:match("(.*)"..database:get(bot_id.."BASHAA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BASHAA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local BASHAA_nnn = database:get(bot_id.."BASHAA:nump"..msg.chat_id_) or 5
local BASHAA_nnn2 = database:get(bot_id.."BASHAA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(BASHAA_nnn2) == tonumber(BASHAA_nnn) or tonumber(BASHAA_nnn2) > tonumber(BASHAA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."BASHAA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✟ عزيزي >>["..BASHAA2.username_.."](https://t.me/"..(BASHAA2.username_ or "D666N")..")\n✟ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BASHAA:teh"..msg.chat_id_).."} بجانب اسمك\n✟ عدد المحاولات المتبقيه {"..(tonumber(BASHAA_nnn) - tonumber(BASHAA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_BASHAAa_new)
end
end
...
local BASHAAChengName = database:get(bot_id.."BASHAA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if BASHAAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BASHAAChengName..']')
database:del(bot_id.."BASHAA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BASHAAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."BASHAA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local BASHAAChengUserName = database:get(bot_id.."BASHAA:Cheng:UserName"..data.id_)
if not data.username_ then 
if BASHAAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BASHAAChengUserName..']')
database:del(bot_id.."BASHAA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BASHAAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."BASHAA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BASHAAChengPhoto = database:get(bot_id.."BASHAA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BASHAAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."BASHAA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BASHAAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."BASHAA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
⍆══•═══𝘽𝙏══•═══⍅
 ✟ ↬𝘽𝘼𝙎𝙃𝘼 𝙏𝙀𝘼𝙈
⍆══•═══𝘽𝙏══•═══⍅
 ✟ ↬[Channel BASHAA](t.me/D666N) 
⍆══•═══𝘽𝙏══•═══⍅
 ✟ ↬[Information](t.me/D666N)
⍆══•═══𝘽𝙏══•═══⍅
 ✟ ↬[DEVELOPER](t.me/S666F)
⍆══•═══𝘽𝙏══•═══⍅
 ✟ ↬[To talk to us](t.me/P0TBOT)
 ⍆══•═══𝘽𝙏══•═══⍅
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevBASHAAW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✟ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'D666N')..') \n ✟ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✟ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'D666N')..') \n ✟ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevBASHAAW(msg) then    
dofile('BASHAA.lua')  
send(msg.chat_id_, msg.id_, ' ✟ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevBASHAAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBASHAAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevBASHAAW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevBASHAAW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBASHAAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevBASHAAW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevBASHAAW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBASHAAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevBASHAAW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevBASHAAW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevBASHAAW(msg) then
...
if database:get(bot_id.."S666F:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'S666F:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."S666F:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'S666F:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBASHAAW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBASHAAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "D666N")
...
function Function_BASHAA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BASHAA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BASHAA, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✟ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'D666N')..')'
status  = '\n ✟ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✟ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✟ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'D666N')..')'
...
database:set(bot_id.."BASHAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BASHAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✟ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BASHAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BASHAA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BASHAA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BASHAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✟ تم منع الكلمه مع التحذير")  
database:del(bot_id.."BASHAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BASHAA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BASHAA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BASHAA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✟ ارسل الكلمه الان")  
database:set(bot_id.."BASHAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BASHAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BASHAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BASHAA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BASHAA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BASHAA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BASHAA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BASHAA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BASHAA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✟ قائمة المنع \n⍆══•═══𝘽𝙏══•═══⍅\n"
for k,v in pairs(list) do  
local BASHAA_Msg = database:get(bot_id.."BASHAA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BASHAA_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevBASHAAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ✟ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevBASHAAW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✟ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'D666N')..')'..'\n ✟ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevBASHAAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBASHAAW(msg) then  
...
if not database:get(bot_id..'S666F:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'S666F:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
send(msg.chat_id_, msg.id_,'['..BASHAA_Msg[math.random(#BASHAA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevBASHAAW(msg) then 
...
if text == ("مسح ردود المطور") and DevBASHAAW(msg) then 
...
if text == ("ردود المطور") and DevBASHAAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✟ قائمة ردود المطور \n⍆══•═══𝘽𝙏══•═══⍅\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevBASHAAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevBASHAAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'باشا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevBASHAAW(msg) then   
...
if text == 'تعطيل المغادره' and DevBASHAAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✟ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BASHAA')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'D666N')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
BASHAAdx(msg.chat_id_, msg.id_, ' ✟ ايدي المجموعة » ( '..msg.chat_id_..' )\n ✟ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✟ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✟ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevBASHAAW(msg) then
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
BASHAA = {'22','30','33','60','90','2','5','36','16','88','50','10','19',};
name = BASHAA[math.random(#BASHAA)]
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
BASHAA = {'معلومات','قنوات','مجموعات','كتاب','تفاحه','مختلف','سدني','فلوس','اعلم','ذئب','تمساح','ذكي',};
name = BASHAA[math.random(#BASHAA)]
...
send(msg.chat_id_, msg.id_, t..'ٴ✟ٴ⍆══•═══𝘽𝙏══•═══⍅ٴ✟○ٴ\n✟ 彡 .[𝘽𝘼𝙎𝙃𝘼 𝙏𝙀𝘼𝙈](t.me/D666N)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'باشا')
...
BASHAA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BASHAA)
...
--------------------------------------------------------------------------------------------------------------
SourceBASHAA(data.message_,data)
...
------------------------------------------------------------------------
local S666F = database:get(bot_id.."BASHAA1:Add:Filter:Rp2"..text..result.chat_id_)   
if S666F then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✟ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✟ ["..S666F.."] \n") 
...
------------------------------------------------------------------------
if text then
local BASHAA1_Msg = database:get(bot_id.."BASHAA1:Add:Filter:Rp2"..text..result.chat_id_)   
if BASHAA1_Msg then    
send(msg.chat_id_, msg.id_," ✟ "..BASHAA1_Msg)
