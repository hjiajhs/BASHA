...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BASHA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BT", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S BASHA -X kill
screen -S BASHA ./BASHA
done
]])  
file:close() 
...
if hash or SudoBot(msg) or DevBASHAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBASHAW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBASHAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBASHAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBASHAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBASHAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local BASHA_Msg = ''  
if msgs < 100 then 
BASHA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BASHA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BASHA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BASHA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BASHA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BASHA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BASHA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BASHA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BASHA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BASHA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BASHA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BASHA_Msg = 'امبراطور التفاعل' 
elseif msgs < 10000000000 then 
BASHA_Msg = 'رب التفاعل'  
end 
return BASHA_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBASHA(msg,data) -- بداية العمل
if msg then
...
--------------------------------------------------------------------------------------------------------------
if (msg.content_.animation_) or (msg.content_.photo_) or (msg.content_.video_) or (msg.content_.video_Message) or (msg.content_.videoMessage_) or (msg.content_.document) or (msg.content_.voice_) or (msg.content_.audio_) or (msg.content_.sticker_) and msg.reply_to_message_id_ == 0 then
...
if DevBASHAW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,BASHA_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✟' and DevBASHAW(msg) then  
...
if text == 'تعطيل التواصل ✟' and DevBASHAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✟' and DevBASHAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✟' and DevBASHAW(msg) then  
...
if text == 'ضع كليشه ستارت ✟' and DevBASHAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ✟ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ✟' and DevBASHAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ✟ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ✟' and DevBASHAW(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/BASHA-TEAM/BASHA/main/BASHA.lua')
send(msg.chat_id_, msg.id_,' ✟ تم تحديث السورس \n ✟ لديك اخر اصدار لسورس باشا\n ✟ الاصدار » { 2.0v}')
dofile('BASHA.lua')  
end
if text == 'الاصدار ✟' and DevBASHAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✟ اصدار سورس باشا \n ✟ الاصدار »{ 2.0v}')
end
if text == 'قناه تحديثات البوت ✟' and DevBASHAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✟ [تحديثات البوت](t.me/D666N) \n ✟ [قناه السورس](t.me/D666N)')
end
if text == "ضع اسم للبوت ✟" and DevBASHAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ✟ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ✟' and DevBASHAW(msg) then 
...
if text == 'المشتركين ✟' and DevBASHAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✟ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✟' and DevBASHAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✟ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✟") and DevBASHAW(msg) then
...
if text == ("قائمه العام ✟") and DevBASHAW(msg) then
...
if text == ("قائمه الكتم العام ✟") and DevBASHAW(msg) then
...
if text=="اذاعه خاص ✟" and msg.reply_to_message_id_ == 0 and DevBASHAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل الان اذاعتك؟ \n ✟ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ✟" and msg.reply_to_message_id_ == 0 and DevBASHAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل الان اذاعتك؟ \n ✟ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ✟" and msg.reply_to_message_id_ == 0 and DevBASHAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل الان اذاعتك؟ \n ✟ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ✟" and msg.reply_to_message_id_ == 0  and DevBASHAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ✟" and msg.reply_to_message_id_ == 0  and DevBASHAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✟ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✟' and DevBASHAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✟" and DevBASHAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✟" and DevBASHAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'✟  عدد الكروبات الان » { '..#group..' }'..BASHAk..''..BASHA..'\n✟  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevBASHAW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevBASHAW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBASHAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBASHAW(msg) then
...
local BASHA1_Msg = database:get(bot_id.."BASHA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BASHA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if BASHA_Msg and not Special(msg) then  
local BASHA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BASHA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBASHAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBASHAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevBASHAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✟ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBASHAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✟ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✟" and DevBASHAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ✟ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✟$") and DevBASHAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✟ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✟" and DevBASHAW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✟" and DevBASHAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ✟ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ✟" and DevBASHAW(msg) then  
...
database:sadd(bot_id.."BASHA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."BASHA:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_BASHA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_BASHA then 
names_BASHA = database:smembers(bot_id.."BASHA:blocname"..msg.chat_id_) or ""
if names_BASHA and names_BASHA[1] then 
for i=1,#names_BASHA do 
if name_BASHA:match("(.*)("..names_BASHA[i]..")(.*)") then 
...
database:set(bot_id.."BASHA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."BASHA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."BASHA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."BASHA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."BASHA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_BASHAa_new(BASHA1,BASHA2)
if BASHA2 and BASHA2.first_name_ then 
if BASHA2.first_name_:match("(.*)"..database:get(bot_id.."BASHA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BASHA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local BASHA_nnn = database:get(bot_id.."BASHA:nump"..msg.chat_id_) or 5
local BASHA_nnn2 = database:get(bot_id.."BASHA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(BASHA_nnn2) == tonumber(BASHA_nnn) or tonumber(BASHA_nnn2) > tonumber(BASHA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."BASHA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✟ عزيزي >>["..BASHA2.username_.."](https://t.me/"..(BASHA2.username_ or "D666N")..")\n✟ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BASHA:teh"..msg.chat_id_).."} بجانب اسمك\n✟ عدد المحاولات المتبقيه {"..(tonumber(BASHA_nnn) - tonumber(BASHA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_BASHAa_new)
end
end
...
local BASHAChengName = database:get(bot_id.."BASHA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if BASHAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BASHAChengName..']')
database:del(bot_id.."BASHA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BASHAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."BASHA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local BASHAChengUserName = database:get(bot_id.."BASHA:Cheng:UserName"..data.id_)
if not data.username_ then 
if BASHAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BASHAChengUserName..']')
database:del(bot_id.."BASHA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BASHAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."BASHA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BASHAChengPhoto = database:get(bot_id.."BASHA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BASHAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."BASHA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BASHAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."BASHA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevBASHAW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevBASHAW(msg) then    
dofile('BASHA.lua')  
send(msg.chat_id_, msg.id_, ' ✟ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevBASHAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBASHAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevBASHAW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevBASHAW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBASHAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevBASHAW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevBASHAW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBASHAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevBASHAW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevBASHAW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevBASHAW(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBASHAW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBASHAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_BASHA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BASHA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BASHA, nil)
return false 
end
...
database:set(bot_id.."BASHA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BASHA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✟ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BASHA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BASHA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BASHA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BASHA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✟ تم منع الكلمه مع التحذير")  
database:del(bot_id.."BASHA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BASHA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BASHA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BASHA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✟ ارسل الكلمه الان")  
database:set(bot_id.."BASHA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BASHA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BASHA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BASHA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BASHA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BASHA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BASHA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BASHA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BASHA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✟ قائمة المنع \n⍆══•═══𝘽𝙏══•═══⍅\n"
for k,v in pairs(list) do  
local BASHA_Msg = database:get(bot_id.."BASHA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BASHA_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevBASHAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ✟ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevBASHAW(msg) then
...
if text == 'تفعيل الاذاعه' and DevBASHAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBASHAW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..BASHA_Msg[math.random(#BASHA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevBASHAW(msg) then 
...
if text == ("مسح ردود المطور") and DevBASHAW(msg) then 
...
if text == ("ردود المطور") and DevBASHAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✟ قائمة ردود المطور \n⍆══•═══𝘽𝙏══•═══⍅\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevBASHAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevBASHAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevBASHAW(msg) then   
...
if text == 'تعطيل المغادره' and DevBASHAW(msg) then  
...
-- vardump(data) 
BASHAdx(msg.chat_id_, msg.id_, ' ✟ ايدي المجموعة » ( '..msg.chat_id_..' )\n ✟ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✟ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✟ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevBASHAW(msg) then
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
BASHA = {'22','30','33','60','90','2','5','36','16','88','50','10','19',};
name = BASHA[math.random(#BASHA)]
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
BASHA = {'معلومات','قنوات','مجموعات','كتاب','تفاحه','مختلف','سدني','فلوس','اعلم','ذئب','تمساح','ذكي',};
name = BASHA[math.random(#BASHA)]
...
BASHA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BASHA)
...
--------------------------------------------------------------------------------------------------------------
SourceBASHA(data.message_,data)
...
------------------------------------------------------------------------
local S666F = database:get(bot_id.."BASHA1:Add:Filter:Rp2"..text..result.chat_id_)   
if S666F then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✟ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✟ ["..S666F.."] \n") 
...
------------------------------------------------------------------------
if text then
local BASHA1_Msg = database:get(bot_id.."BASHA1:Add:Filter:Rp2"..text..result.chat_id_)   
if BASHA1_Msg then    
send(msg.chat_id_, msg.id_," ✟ "..BASHA1_Msg)
